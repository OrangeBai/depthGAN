...
def res14(input_tensor, activation='LeakyReLU'):
    x = conv_layer(input_tensor, 32, (3, 3), activation,  name='Conv1')
    ...
    x = res_block(x, 256, (1, 1), activation, 'block3_2', identity_block=True)
    ...
    x = res_block(x, 512, (2, 2), activation, 'block5_1', identity_block=False)
    x = res_block(x, 512, (1, 1), activation, 'block5_2', identity_block=True)
